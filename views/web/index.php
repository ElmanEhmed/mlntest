...
<div class="w3l-header" id="home">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark pl-0 pr-0">
            <a class="navbar-brand m-0 text-primary" href="/"><span class="fa fa-gamepad"></span> Eccentric </a> 
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mr-lg-4">
                        <a class="nav-link pl-0 pr-0 font-weight-bold"  href="/?view=about">About</a>
                    </li>
                    <li class="nav-item mr-lg-4">
                        <a class="nav-link pl-0 pr-0 font-weight-bold" href="/?view=services">Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-0 pr-0 font-weight-bold"  href="/?view=contact">Contact</a>
                    </li>
                </ul>
            </div>
        </nav>
